...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamneto)\n/* harmony export */ });\nfunction initFuncionamneto() {\n  var funcionamneto = document.querySelector('[data-semana]');\n  var diasSemana = funcionamneto.dataset.semana.split(',').map(Number);\n  var horarioSemana = funcionamneto.dataset.horario.split(',').map(Number);\n  var dataAgora = new Date();\n  var diaAgora = dataAgora.getDay();\n  var horarioAgora = dataAgora.getHours();\n  var semanaAberto = diasSemana.indexOf(diaAgora) !== -1;\n  var horarioAberto = horarioAgora >= horarioSemana[0] && horarioAgora < horarioSemana[1];\n  if (horarioAberto && semanaAberto) {\n    funcionamneto.classList.add('aberto');\n  }\n}\n\n//# sourceURL=webpack://modules/./js/funcionamento.js?");
